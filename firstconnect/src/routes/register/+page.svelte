<script lang="ts">
    ...
    async function create() {
        ...
        "zip_code": zip
          ...
          await pb.collection("mentees").create({
        "email" : email,
        "password" : password,
        "passwordConfirm" : password,
        "name" : name,
...
<form class="container mt-5">
  ...
  <h2 class="text-center mb-5">The trusted source for connecting FIRST mentors and mentees!</h2>

  <!-- Mentor or Mentee selection -->
  <div class="mb-4">
    <h3>Do you want to be a mentor or to be a mentee?</h3>
  ...
  <div class="mb-4">
    <h4>Which programs would you like to mentor?</h4>
    <div class="form-check">
  ...
  <div class="mb-4">
    <h4>Which program are you in?</h4>
    <div class="form-check">
  ...
  <div class="mb-4">
    <h4>Are you an individual or a team?</h4>
    <div class="form-check">
  ...
  {#if individual}
    ...
    <div class="mb-3">
      <label for="name" class="form-text">What is your name?</label>
      <input type="text" class="form-control" bind:value={name} id="name">
    </div>
  {:else if individual === false}
    <!-- Team's name and number inputs -->
    <div class="mb-3">
      <label for="teamName" class="form-text">What is your team name?</label>
      <input type="text" class="form-control" bind:value={name} id="teamName">
    </div>
    <div class="mb-3">
      <label for="teamNumber" class="form-text">What is your team number?</label>
  ...
  <div class="mb-3">
    <label for="password" class="form-label">Password (min length 5)</label>
